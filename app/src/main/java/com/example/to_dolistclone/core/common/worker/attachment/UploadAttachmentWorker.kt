...
//        val attachmentId = workerParams.inputData.getString(ATTACHMENT_ID_WORKER_DATA)
        val attachmentPath = workerParams.inputData.getString(ATTACHMENT_INITIAL_FILE_PATH_WORKER_DATA)

        return if (userId == null/* || attachmentId == null*/ || attachmentPath == null) {
            ...
            try {
                todoRepository.uploadAttachment(userId, attachmentPath)
