...
data class TodoShortcutUiState(
    val categories: Set<String> = emptySet(), val selectedCategory: String? = null, val errorMsg: String? = null
)
...
class TodoShortcutViewModel @Inject constructor(
    ...
    val uiState = combine(selectedCategory, todoCategories, errorMsg) { selectedCategory, todoCategories, errorMsg ->
